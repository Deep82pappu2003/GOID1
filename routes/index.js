...
router.get("/driver_account",(req,res)=>{
    ...
    const driver = req.session.user; // Assuming driver details are stored in session
...
// router.get("/ride",isLoggedIn,function(req,res){
//     let isLoggedIn = req.session.isLoggedIn;
//     res.render("ride",{isLoggedIn: isLoggedIn});
//     // res.redirect("/ride");
// });
